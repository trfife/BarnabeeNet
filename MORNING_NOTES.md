...
<!-- Work will be logged here as I progress -->
...
<!-- Config changes you need to review/make -->

### Home Assistant Setup
<!-- HA automations, scripts, or entities to configure -->
...
<!-- List of redundant/obsolete code removed -->
